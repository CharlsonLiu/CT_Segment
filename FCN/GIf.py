...
FCNLog_path = 'train_result_2.csv'
FCNtest_path = 'fcn_iou_values_2.csv'
...
if __name__ == '__main__':
    ...
    anim = animation.FuncAnimation(fig, update, frames=len(list(csv.reader(open(FCNLog_path)))), repeat=False)
    anim.save('FCN_Test.gif', writer='pillow')

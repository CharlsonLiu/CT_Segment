...
# 修改：
weights = 'params/bestWeight/fcn_epoch_5.pth'
...
if os.path.exists(weights):
    fcn_model.load_state_dict(torch.load(weights))
...
plt.title('FCN Intersection over Union')
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        with open(result_path, 'w') as f:
            json.dump(result, f)
        with open('fcn_iou_values.csv', mode='w') as csv_file:
